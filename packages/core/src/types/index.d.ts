...
export type DTCGTokenType = 'color' | 'dimension' | 'font-family' | 'font-weight' | 'duration' | 'cubic-bezier' | 'number' | 'stroke-style' | 'border' | 'transition' | 'shadow' | 'gradient' | 'typography';
